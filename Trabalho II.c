...
/*Implemente dois dos seguintes algoritmos de ordenação: Quicksort, Shellsort, Heapsort ou Mergesort.

Critério de Avaliação:

1) Os algoritmos estão corretamente implementados – Até 7 pontos.
2) Algumas novidades (Novidade pode ser uma boa interface, ordenação de um
    vetor de registros por uma determinada chave, etc.) – Até 3 pontos.*/
